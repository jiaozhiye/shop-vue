 ...
 * @Last Modified time: 2020-06-13 12:52:23
 */
...
export var Editor = {
  ...
  mounted: function() {
    ...
    if (getTinymce() !== null) {
      ...
      var scriptSrc = isNullOrUndefined(this.$props.tinymceScriptSrc) ? '/static/tinymce/tinymce.min.js' : this.$props.tinymceScriptSrc;
